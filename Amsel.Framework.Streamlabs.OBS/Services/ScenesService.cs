...
namespace Amsel.Framework.Streamlabs.OBS.Services
{
    public class ScenesService
    {
        ...
        public readonly StreamlabsOBSSubscriptionHandler<StreamlabsOBSItem> ItemRemoved
            = new StreamlabsOBSSubscriptionHandler<StreamlabsOBSItem>(new StreamlabsOBSRequest("itemRemoved",
                                                                                               RESOURCE));

        public readonly StreamlabsOBSSubscriptionHandler<StreamlabsOBSItem> ItemUpdated
            = new StreamlabsOBSSubscriptionHandler<StreamlabsOBSItem>(new StreamlabsOBSRequest("itemUpdated",
                                                                                               RESOURCE));

        public readonly StreamlabsOBSSubscriptionHandler<StreamlabsOBSScene> SceneAdded
            = new StreamlabsOBSSubscriptionHandler<StreamlabsOBSScene>(new StreamlabsOBSRequest("sceneAdded",
                                                                                                RESOURCE));

        public readonly StreamlabsOBSSubscriptionHandler<StreamlabsOBSScene> SceneRemoved
            = new StreamlabsOBSSubscriptionHandler<StreamlabsOBSScene>(new StreamlabsOBSRequest("sceneRemoved",
                                                                                                RESOURCE));
        ...
        public StreamlabsOBSScene ActiveScene() {
            return client.SendRequest<StreamlabsOBSScene>(new StreamlabsOBSRequest("activeScene", RESOURCE))
                         ?.FirstOrDefault();
        }
        ...
        public StreamlabsOBSScene CreateScene(string name) {
            return client.SendRequest<StreamlabsOBSScene>(new StreamlabsOBSRequest("createScene", RESOURCE, name))
                         ?.FirstOrDefault();
        }

        public StreamlabsOBSScene GetScene(string id) {
            return client.SendRequest<StreamlabsOBSScene>(new StreamlabsOBSRequest("getScene", RESOURCE, id))
                         ?.FirstOrDefault();
        }
        ...
        public StreamlabsOBSSceneBase RemoveScene(string id) {
            return client.SendRequest<StreamlabsOBSSceneBase>(new StreamlabsOBSRequest("removeScene", RESOURCE, id))
                         ?.FirstOrDefault();
        }
